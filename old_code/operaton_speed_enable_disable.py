...
#from pymodbus.client.sync import ModbusSerialClient   #basic code for forward ,enable disable and operation mode code
import time
...
try:
    ...
    client = ModbusSerialClient(method='rtu', port='/dev/ttyUSB0', baudrate=38400, stopbits=1, parity='N', bytesize=8)
    client.connect()
